...
type: source
doc_id: SRC-APL-009
file_path: "../../Apollo 2024 September.csv"
file_type: csv
...
# Apollo Energy GL - September 2024

## File Details
- **Original filename:** `Apollo 2024 September.csv`
- **File path:** `../../Apollo 2024 September.csv`
- **Type:** csv
- **Entity:** [[Apollo Energy Resources LLC]]
- **Period covered:** September 2024

## Contents Summary
Monthly general ledger export for Apollo Energy, September 2024. Contains all journal entries, debits/credits, and account activity for the month.
...
- [[Revenue Timing Shift]] — September 2024 GL entries tested for revenue recognition timing
