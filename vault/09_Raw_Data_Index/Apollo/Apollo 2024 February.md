...
type: source
doc_id: SRC-APL-002
file_path: "../../Apollo 2024 February.csv"
file_type: csv
...
# Apollo Energy GL - February 2024

## File Details
- **Original filename:** `Apollo 2024 February.csv`
- **File path:** `../../Apollo 2024 February.csv`
- **Type:** csv
- **Entity:** [[Apollo Energy Resources LLC]]
- **Period covered:** February 2024

## Contents Summary
Monthly general ledger export for Apollo Energy, February 2024. Contains all journal entries, debits/credits, and account activity for the month.
...
- [[Revenue Timing Shift]] — February 2024 GL entries tested for revenue recognition timing
