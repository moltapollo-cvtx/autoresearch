...
type: source
doc_id: SRC-APL-008
file_path: "../../Apollo 2024 August.csv"
file_type: csv
...
# Apollo Energy GL - August 2024

## File Details
- **Original filename:** `Apollo 2024 August.csv`
- **File path:** `../../Apollo 2024 August.csv`
- **Type:** csv
- **Entity:** [[Apollo Energy Resources LLC]]
- **Period covered:** August 2024

## Contents Summary
Monthly general ledger export for Apollo Energy, August 2024. Contains all journal entries, debits/credits, and account activity for the month.
...
- [[Revenue Timing Shift]] — August 2024 GL entries tested for revenue recognition timing
