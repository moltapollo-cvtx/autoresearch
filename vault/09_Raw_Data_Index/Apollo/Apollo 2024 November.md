...
type: source
doc_id: SRC-APL-011
file_path: "../../Apollo 2024 November.csv"
file_type: csv
...
# Apollo Energy GL - November 2024

## File Details
- **Original filename:** `Apollo 2024 November.csv`
- **File path:** `../../Apollo 2024 November.csv`
- **Type:** csv
- **Entity:** [[Apollo Energy Resources LLC]]
- **Period covered:** November 2024

## Contents Summary
Monthly general ledger export for Apollo Energy, November 2024. Contains all journal entries, debits/credits, and account activity for the month.
