...
type: source
doc_id: SRC-APL-022
file_path: "../../Apollo 2025 October.csv"
file_type: csv
...
# Apollo Energy GL - October 2025

## File Details
- **Original filename:** `Apollo 2025 October.csv`
- **File path:** `../../Apollo 2025 October.csv`
- **Type:** csv
- **Entity:** [[Apollo Energy Resources LLC]]
- **Period covered:** October 2025

## Contents Summary
Monthly general ledger export for Apollo Energy, October 2025. Contains all journal entries, debits/credits, and account activity for the month.
