...
type: source
doc_id: SRC-APL-007
file_path: "../../Apollo 2024 July.csv"
file_type: csv
...
# Apollo Energy GL - July 2024

## File Details
- **Original filename:** `Apollo 2024 July.csv`
- **File path:** `../../Apollo 2024 July.csv`
- **Type:** csv
- **Entity:** [[Apollo Energy Resources LLC]]
- **Period covered:** July 2024

## Contents Summary
Monthly general ledger export for Apollo Energy, July 2024. Contains all journal entries, debits/credits, and account activity for the month.
...
- [[Revenue Timing Shift]] — July 2024 GL entries tested for revenue recognition timing
