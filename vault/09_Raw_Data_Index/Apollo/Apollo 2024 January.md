...
type: source
doc_id: SRC-APL-001
file_path: "../../Apollo 2024 January.csv"
file_type: csv
...
# Apollo Energy GL - January 2024

## File Details
- **Original filename:** `Apollo 2024 January.csv`
- **File path:** `../../Apollo 2024 January.csv`
- **Type:** csv
- **Entity:** [[Apollo Energy Resources LLC]]
- **Period covered:** January 2024

## Contents Summary
Monthly general ledger export for Apollo Energy, January 2024. Contains all journal entries, debits/credits, and account activity for the month.
...
- [[Revenue Timing Shift]] — January 2024 GL entries tested for revenue recognition timing
