...
type: source
doc_id: SRC-APL-003
file_path: "../../Apollo 2024 March.csv"
file_type: csv
...
# Apollo Energy GL - March 2024

## File Details
- **Original filename:** `Apollo 2024 March.csv`
- **File path:** `../../Apollo 2024 March.csv`
- **Type:** csv
- **Entity:** [[Apollo Energy Resources LLC]]
- **Period covered:** March 2024

## Contents Summary
Monthly general ledger export for Apollo Energy, March 2024. Contains all journal entries, debits/credits, and account activity for the month.
...
- [[Revenue Timing Shift]] — March 2024 GL entries tested for revenue recognition timing
